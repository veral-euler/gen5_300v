...
typedef struct {
  double Integrator_DSTATE;            /* '<S116>/Integrator' */
  double Filter_DSTATE;                /* '<S111>/Filter' */
  double Integrator_DSTATE_h;          /* '<S62>/Integrator' */
  double Filter_DSTATE_d;              /* '<S57>/Filter' */
  double Delay_DSTATE;                 /* '<S3>/Delay' */
  double Integrator_DSTATE_b;          /* '<S182>/Integrator' */
  double Filter_DSTATE_i;              /* '<S177>/Filter' */
