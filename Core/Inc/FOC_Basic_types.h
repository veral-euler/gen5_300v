...
#ifndef FOC_Basic_types_h_
#define FOC_Basic_types_h_
...
typedef struct tag_RTM_FOC_Basic_T RT_MODEL_FOC_Basic_T;

#endif                                 /* FOC_Basic_types_h_ */
