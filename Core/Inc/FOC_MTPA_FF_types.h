...
#ifndef FOC_MTPA_FF_types_h_
#define FOC_MTPA_FF_types_h_
...
typedef struct tag_RTM_FOC_MTPA_FF_T RT_MODEL_FOC_MTPA_FF_T;

#endif                                 /* FOC_MTPA_FF_types_h_ */
